...
class _ArrayNamespace(Protocol):
    ...
    # Data type functions (https://data-apis.org/array-api/latest/API_specification/data_type_functions.html)
    def astype(self, x: "Array", dtype: Any, /, *, copy: bool = True) -> "Array": ...

    # Array creation and manipulation
    def asarray(self, obj: Any, /, *, dtype: Any = None, device: Any = None, copy: bool = False) -> "Array": ...
    def ascontiguousarray(self, x: "Array", /, *, dtype: Any = None) -> "Array": ...
